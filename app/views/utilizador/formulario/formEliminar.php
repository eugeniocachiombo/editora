 <!--MAIN-->
 <form action="/utilizador/Eliminar" method="post" class="needs-validation" novalidate>
                     ...
                     <div class="col pt-2">
                         <center>
                             ...
                             <div class="col-8" style="margin-top: -15px">
                                 ...
                                 <select name="txtIdUtilizador" id="txtIdUtilizador" class="form-control custom-select"
                                     required>
                                     ...
                                     <?php 
                                        ...
                                        if(!empty($_SESSION["idUtilizador"]) && $_SESSION["tipoAcesso"] != "ceo"){
                                            ...
                                            ?>
                                     <option selected value="<?php echo $utilizador["idUtilizador"];?>">
