        ...
        <nav aria-label="Page navigation example ">
            <ul class="pagination  pt-5">
                ...
                <li class="page-item"><a class="page-link"
                        href="<?php echo "/painel/Obras/pagina=paginaEstilos=".$voltar; ?>">Voltar</a></li>
                <?php } ?>

                <!-- Paginamento -->
                <?php if($paginaActual > 1 && $totalPaginas > 1){ ?>
                <a onClick="Hover()" class="link page-link"
                    href="<?php echo "/painel/Obras/pagina=paginaEstilos=".($paginaActual-1); ?>">
                    <li><?php echo ($paginaActual-1); ?></li>
                </a>
                <?php } ?>

                <a onClick="Hover()" class="link page-link"
                    href="<?php echo "/painel/Obras/pagina=paginaEstilos=".$paginaActual; ?>"
                ...
                <a onClick="Hover()" class="link page-link"
                    href="<?php echo "/painel/Obras/pagina=paginaEstilos=".($paginaActual+2); ?>">
                ...
                <li class="page-item"><a class="page-link"
                        href="<?php echo "/painel/Obras/pagina=paginaEstilos=".$avancar; ?>">Avançar</a></li>
                <?php } ?>
