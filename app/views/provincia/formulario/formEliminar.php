 <!--MAIN-->
 <form action="/provincia/Eliminar" method="post" class="needs-validation" novalidate>
                     ...
                     <div class="col pt-2">
                         <center>
                             ...
                             <div class="col-8" style="margin-top: -15px">
                                 ...
                                 <select onChange="BuscarProvinciaes(this.value)" name="txtIdProvincia"
                                     id="txtIdProvincia" class="form-control custom-select" required>
                                     <option value="">Selecione</option>
                                     <?php 
                                        $Provinciaes = new ProvinciaDao();
                                        $lista = $Provinciaes->Buscar();
 ...
 <script src="/assets/js/provincia/ajaxBuscarProvinciaes.js"></script>
