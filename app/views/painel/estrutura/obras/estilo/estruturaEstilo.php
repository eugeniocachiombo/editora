            ...
            <div class="criar " style="">
                <?php 
                    if(!empty($uri[3]) && $uri[3] == "Adicionar"){
                       require "../app/views/estilo/formulario/formCadastro.php"; 
                    }
                ?>
            </div>
            ...
            <div class="actualizar " style="">
                <?php 
                    if(!empty($uri[3]) && $uri[3] == "Actualizar"){
                       require "../app/views/estilo/formulario/formActualizar.php"; 
                    }
                ?>
            </div>
            ...
            <div class="eliminar " style="">
                <?php 
                    if(!empty($uri[3]) && $uri[3] == "Eliminar"){
                       require "../app/views/estilo/formulario/formEliminar.php"; 
                    }
                ?>
            </div>
...
<script>
        // ACENDER O BOTÃO
            estilo.style = "background: #299; color: white";
        ...
        function Criar(){
            ...
            window.location = "/painel/Obras/Estilo/Adicionar";     
        }
        ...
        function Actuallizar(){
            ...
            listar.style = "display: none";
            eliminar.style = "display: none";
            window.location = "/painel/Obras/Estilo/Actualizar";
        }
        ...
        function Listar(){
            ...
            eliminar.style = "display: none";
            window.location = "/painel/Obras/Estilo/Listar";
        }
        ...
        function Eliminar(){
            ...
            window.location = "/painel/Obras/Estilo/Eliminar";
        }
