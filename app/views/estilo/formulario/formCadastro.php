<!--MAIN-->
<form action="/estilo/Cadastrar" method="post" class="needs-validation" novalidate>
                ...
                <div class="col pb-1 ">
                    <center>
                        <div class="col-8 pb-5 mb-3 d-none d-md-block d-lg-block d-xl-block"
                            ...
                            <legend class=""><b>Adicionar Estilo</b></legend>
                        </div>

                        <div class="col d-md-none d-lg-none d-xl-none">
                            <h5><b>Adicionar Estilo</b></h5>
                        </div>
                    </center>
                </div>
            </div>
                    ...
                    <center>
                        <div class="col mb-5" style="width: 220px;">
                            <input onClick="ClickLogar()" name="btnSubmit" class="btn" type="submit"
                                value="Adicionar Estilo" id="btnLogar" style="width: 100%;"> <br><span id="spinner"
                                class=''></span>
                            <br>
