<!--MAIN-->
<form action="/utilizador/Actualizar" method="post" class="needs-validation" novalidate>

    <div class="container-fluid d-table d-md-flex justify-content-center align-items-center "
                ...
                <div class="col pb-1 ">
                    <center>
                        <div class="col-8 pb-5 mb-3 d-none d-md-block d-lg-block d-xl-block"
                            ...
                            <legend class="">Actualizar Dados</legend>
                        </div>

                        <div class="col d-md-none d-lg-none d-xl-none">
                            <h5>Actualizar Dados</h5>
                        </div>
                    </center>
                </div>
            </div>
            ...
            <div class="col text-center" style="height: auto">
                    ...
                    <div class="col pt-2">
                        <center>
                            <div class="col-8  d-none d-md-block d-lg-block d-xl-block">
                                <label for="idUtilizador" style="width: 100%; text-align: left; width: 200px;">
                            ...
                            <div class="col-8" style="margin-top: -15px; width: 200px">
                                <select onChange="BuscarUtilizadores(this.value)" name="txtIdUtilizador"
                                    id="txtIdUtilizador" class="form-control custom-select" required>
                                    <option selected value="">Selecione</option>
                                    <?php 
                                        $utilizadores = new UtilizadorDao();
                                        if(!empty($_SESSION["idUtilizador"])){
                                            $idUtilizador = $_SESSION["idUtilizador"];
                                            $utilizador = $utilizadores->BuscarTodosDadosID($idUtilizador);
                                            ?>
                                ...
                                <center>
                                    ...
                                    <div class="col-8" style="margin-top: -15px">
                                        <input title="Deve conter no míninimo 5 caracteres" minlength="5"
                                            pattern="[0-9]{9}[A-Z]{2}[0-9]{3}" maxlength="20" required
                                            class="form-control" type="text" name="txtNIFUtilizador"
                                            id="txtNIFUtilizador">
                                        <div class="invalid-feedback" style="font-size: 16px; text-align: left">
                            ...
                            <div class="col d-none pt-2">
                                <div class="row">
                                    <center>
                                        ...
                                        <div class="col-8" style="margin-top: -15px">
                                            <input title="Deve conter no míninimo 6 caracteres" minlength="6"
                                                maxlength="20" required class="form-control" type="text"
                                                name="txtPasseUtilizador" id="txtPasseUtilizador">
                                            <div class="invalid-feedback" style="font-size: 16px; text-align: left">
                                ...
                                <center>
                                    ...
                                    <div class="col-8 align-items-center" style="margin-top: -15px" required>
                                        <select name="txtTipoAcessoUtilizador" id="txtTipoAcessoUtilizador"
                                            ...
                                            <option selected value="">Selecione...</option>
                                            <?php 
                                                    $tipoAcessos = new TipoAcessoDao();
                                                    $lista = $tipoAcessos->Buscar();
                                                    foreach ($lista as $tipoAcesso) { ?>
                                            <option value="<?php echo $tipoAcesso["idTipoAcesso"];?>">
                                                <?php echo $tipoAcesso["descricaoTipoAcesso"];?>
                                            </option>
                                            <?php   
                                                    } 
                                            ?>
                ...
                <div class="col text-center" style="height: auto">
                    ...
                    <div class="col d-flex justify-content-center pt-4">
                        <center>
                            <div class="col mb-5">
                                <input name="btnSubmit" class="btn" type="submit" value="Actualizar" id="btnLogar"
                                    style="width: 185px"> <br><span id="spinner" class=''></span>
                            </div>
                        </center>
                    </div>
                </div>
