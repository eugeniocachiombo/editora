...
<div class="col text-left text-dark" style="border-radius: 10px; margin-top: 10px; width: 100%">
            ...
            <div class="criar " style="">
                <?php 
                    if(!empty($uri[3]) && $uri[3] == "Adicionar"){
                       require "../app/views/obra/formulario/formCadastro.php"; 
                    }
                ?>
            </div>
            ...
            <div class="actualizar" style="">
                <?php 
                    if(!empty($uri[3]) && $uri[3] == "Actualizar"){
                       require "../app/views/obra/formulario/formActualizar.php"; 
                    }
                ?>
            </div>

            <div class="listar" style=" display: block; ">
                <?php 
            ...
            <div class="eliminar " style="">
                <?php 
                    if(!empty($uri[3]) && $uri[3] == "Eliminar"){
                       require "../app/views/obra/formulario/formEliminar.php"; 
                    }
                ?>
            </div>
            ...
            <div class="col text-center d-table d-md-flex bg-white text-dark" style="border: 5px solid #299;border-radius: 10px; margin-top: 10px; width: 100%">
                ...
                <button id="btnCriar" onClick="Criar()" style=" font-weight: bold; border-bottom: 5px solid black; border-radius: 10px; width: 300px" class="btn w-50 m-3 border border-warnning p-1" type="button" value="Adicionar">
...
<script>
        // ACENDER O BOTÃO
            obra.style = "background: #299; color: white";
        ...
        function Criar(){
            ...
            window.location = "/painel/Obras/Obra/Adicionar";     
        }
        ...
        function Actuallizar(){
            ...
            listar.style = "display: none";
            eliminar.style = "display: none";
            window.location = "/painel/Obras/Obra/Actualizar";
        }
        ...
        function Listar(){
            ...
            actualizar.style = "display: none";
            eliminar.style = "display: none";
            window.location = "/painel/Obras/Obra/Listar";
        }
        ...
        function Eliminar(){
            ...
            window.location = "/painel/Obras/Obra/Eliminar";
        }
