...
<!--MAIN-->
<form action="/cargoArtistaBanda/Eliminar" method="post" class="needs-validation" novalidate>

<div class="container-fluid bg-white pt-5 text-dark" style="min-height: 62vh; border-radius: 10px;border: 5px solid #299; padding-right: 0">
                ...
                <!--ICONE CargoArtistaBanda-->
                    ...
                    <div class="col pb-1 ">
                        ...
                        <div class="col-8 pb-5 mb-3 d-none d-md-block d-lg-block d-xl-block" style="text-align: center;">
                            <legend class="">Eliminar Cargo de Banda</legend>
                        </div>

                        <div class="col d-md-none d-lg-none d-xl-none">
                            <h5>Eliminar Cargo de Banda</h5>
                        </div>
                        </center>
                    </div>
            </div>
                        ...
                        <div class="col pt-2">
                            <center>
                                <div class="col  d-none d-md-block d-lg-block d-xl-block" >
                                    <label for="idCargoArtistaBanda" style="width: 220px; text-align: left;"><p class="p"><b>Cargo do Artísta na Banda:</b></p></label>
                                </div>
                                ...
                                <div class="col-8" style="margin-top: -15px; width: 220px;">
                                    <select onChange="BuscarCargoArtistaBandas(this.value)" name="txtIdCargoArtistaBanda" id="txtIdCargoArtistaBanda" class="form-control custom-select" required>
                    ...
                    <div class="col d-flex justify-content-center pt-4">
                        <center>
                            <div class="col mb-5" style="width: 220px;">
                                <input onClick="ClickLogar()" name="btnSubmit" class="btn" type="submit" value="Eliminar Cargo" id="btnLogar" style="width: 100%"> <br><span id="spinner" class=''></span>
                                <br>
                            </div>
                        </center>
                    </div>
