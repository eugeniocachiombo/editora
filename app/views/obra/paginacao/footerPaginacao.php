        ...
        <nav aria-label="Page navigation example ">
            <ul class="pagination  pt-5">
                ...
                <li class="page-item"><a class="page-link"
                        href="<?php echo "/painel/Obras/pagina=paginaObras=".$voltar; ?>">Voltar</a></li>
                <?php } ?>

                <!-- Paginamento -->
                <?php if($paginaActual > 1 && $totalPaginas > 1){ ?>
                <a onClick="Hover()" class="link page-link"
                    href="<?php echo "/painel/Obras/pagina=paginaObras=".($paginaActual-1); ?>">
                    <li><?php echo ($paginaActual-1); ?></li>
                </a>
                <?php } ?>

                <a onClick="Hover()" class="link page-link"
                    href="<?php echo "/painel/Obras/pagina=paginaObras=".$paginaActual; ?>"
                ...
                <a onClick="Hover()" class="link page-link"
                    href="<?php echo "/painel/Obras/pagina=paginaObras=".($paginaActual+2); ?>">
                ...
                <li class="page-item"><a class="page-link"
                        href="<?php echo "/painel/Obras/pagina=paginaObras=".$avancar; ?>">Avançar</a></li>
                <?php } ?>
