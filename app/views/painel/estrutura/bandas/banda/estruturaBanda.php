            ...
            <div class="adicionar" style="">
                <?php 
                    if(!empty($uri[3]) && $uri[3] == "Adicionar"){
                       require "../app/views/banda/formulario/formCadastro.php"; 
                    }
                ?>
            </div>
            ...
            <div class="actualizar " style="">
                <?php 
                    if(!empty($uri[3]) && $uri[3] == "Actualizar"){
                       require "../app/views/banda/formulario/formActualizar.php"; 
                    }
                ?>
            </div>
            ...
            <div class="eliminar " style="">
                <?php 
                    if(!empty($uri[3]) && $uri[3] == "Eliminar"){
                       require "../app/views/banda/formulario/formEliminar.php"; 
                    }
...
<script>
        // ACENDER O BOTÃO
            banda.style = "background: #299; color: white";
        ...
        function Adicionar(){
            ...
            window.location = "/painel/Bandas/Banda/Adicionar";     
        }
        ...
        function Actuallizar(){
            ...
            listar.style = "display: none";
            eliminar.style = "display: none";
            window.location = "/painel/Bandas/Banda/Actualizar";
        }
        ...
        function Listar(){
            ...
            eliminar.style = "display: none";
            window.location = "/painel/Bandas/Banda/Listar";
        }
        ...
        function Eliminar(){
            ...
            window.location = "/painel/Bandas/Banda/Eliminar";
        }
