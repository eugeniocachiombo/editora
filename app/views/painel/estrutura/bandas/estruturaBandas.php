        ...
        <div class="col mt-2 pb-4 d-flex justify-content-center" style="display: block; flex-wrap: wrap; background: #57489b;">
            <div class="d-table justify-content-center" style="width: 100%">
                ...
                <div class="col text-center d-table d-md-flex bg-white text-dark" style="border: 5px solid #299;border-radius: 10px; margin-top: 10px; width: 100%">
                    ...
                    <button id="banda" onClick="Banda()" style=" font-weight: bold; border-bottom: 5px solid black; border-radius: 10px; width: 300px" class="btn w-50 m-3 border border-warnning p-1" type="button" >
                            <i class='fas fa-guitar' style="font-size: 20px"></i> Bandas
                    </button>
                    

                    <button id="cargoArtistaBanda" onClick="CargoArtistaBanda()" style=" font-weight: bold; border-bottom: 5px solid black; border-radius: 10px; width: 300px" class="btn w-50 m-3 border border-warnning p-1" type="button" >
...
<script>
        ...
        function Banda(){ window.location = "/painel/Bandas/Banda"; }
        function CargoArtistaBanda(){ window.location = "/painel/Bandas/CargoArtistaBanda"; }
</script>
