<!--MAIN-->
<form action="/artista/Cadastrar" method="post" class="needs-validation" novalidate>
                ...
                <div class="col pb-1 ">
                    <center>
                        <div class="col-8 pb-5 mb-3 d-none d-md-block d-lg-block d-xl-block"
                            ...
                            <legend class="">Adicionar Artísta</legend>
                        </div>

                        <div class="col d-md-none d-lg-none d-xl-none">
                            <h5>Adicionar Artísta</h5>
                        </div>
                    </center>
                </div>
            </div>
                    ...
                    <center>
                        <div class="col mb-5" style="width: 200px">
                            <input onClick="ClickLogar()" name="btnSubmit" class="btn" type="submit"
                                value="Adicionar Artísta" name="btnSubmit" id="btnSubmit" style="width: 100%;">
