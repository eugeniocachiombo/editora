            ...
            <div class="adicionar " style="">
                <?php 
                    if(!empty($uri[3]) && $uri[3] == "Adicionar"){
                       require "../app/views/cargoArtista/formulario/formCadastro.php"; 
                    }
                ?>
            </div>
            ...
            <div class="actualizar " style="">
                <?php 
                    if(!empty($uri[3]) && $uri[3] == "Actualizar"){
                       require "../app/views/cargoArtista/formulario/formActualizar.php"; 
                    }
                ?>
            </div>
            ...
            <div class="eliminar " style="">
                <?php 
                    if(!empty($uri[3]) && $uri[3] == "Eliminar"){
                       require "../app/views/cargoArtista/formulario/formEliminar.php"; 
                    }
                ?>
            </div>
...
<script>
        // ACENDER O BOTÃO
            cargoArtista.style = "background: #299; color: white";
        ...
        function Adicionar(){
            ...
            window.location = "/painel/Artistas/CargoArtista/Adicionar";     
        }
        ...
        function Actuallizar(){
            ...
            listar.style = "display: none";
            eliminar.style = "display: none";
            window.location = "/painel/Artistas/CargoArtista/Actualizar";
        }
        ...
        function Listar(){
            ...
            eliminar.style = "display: none";
            window.location = "/painel/Artistas/CargoArtista/Listar";
        }
        ...
        function Eliminar(){
            ...
            window.location = "/painel/Artistas/CargoArtista/Eliminar";
        }
