    ...
    <div class="col d-flex justify-content-center">
        <nav aria-label="Page navigation example ">
            <ul class="pagination  pt-5">
                ...
                <!--Encaminhar -->
                <?php if( $_SERVER["REQUEST_URI"] == "/painel/Conversas" ){ ?>
                <script>
                    window.location = "<?php echo " / painel / Conversas / pagina = paginaChat = ".$totalPaginas; ?>";
                </script>
                <?php } ?>
                ...
                <li class="page-item"><a class="page-link"
                        href="<?php echo "/painel/Conversas/pagina=paginaChat=".$voltar; ?>">Voltar</a></li>
                <?php } ?>

                <!-- Paginamento -->
                <?php if($paginaActual > 1 && $totalPaginas > 1){ ?>
                <a onClick="Hover()" class="link page-link"
                    href="<?php echo "/painel/Conversas/pagina=paginaChat=".($paginaActual-1); ?>">
                    <li><?php echo ($paginaActual-1); ?></li>
                </a>
                <?php } ?>

                <a onClick="Hover()" class="link page-link"
                    href="<?php echo "/painel/Conversas/pagina=paginaChat=".$paginaActual; ?>"
                ...
                <a onClick="Hover()" class="link page-link"
                    href="<?php echo "/painel/Conversas/pagina=paginaChat=".($paginaActual+2); ?>">
                ...
                <li class="page-item"><a class="page-link"
                        href="<?php echo "/painel/Conversas/pagina=paginaChat=".$avancar; ?>">Avançar</a></li>
                <?php } ?>
