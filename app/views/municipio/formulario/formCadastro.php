<!--MAIN-->
<form action="/municipio/Cadastrar" method="post" class="needs-validation" novalidate>
                            ...
                            <center>
                                ...
                                <div class="col-8" style="margin-top: -15px">
                                    <input title="Deve conter no míninimo 3 caracteres" minlength="3"
                                        ...
                                        class="form-control" type="text" name="txtNomeMunicipio" id="txtNomeMunicipio">
                        ...
                        <div class="col pt-2">
                            <center>
                                ...
                                <div class="col-8 align-items-center" style="margin-top: -15px" required>
                                    <select name="txtIdProvincia" id="txtIdProvincia" class="form-control custom-select"
                                        required>
