<!--MAIN-->
<form action="/provincia/Actualizar" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="col pt-2">
                        <center>
                            ...
                            <div class="col-8" style="margin-top: -15px">
                                ...
                                <select onChange="BuscarProvincias(this.value)" name="txtIdProvincia"
                                    id="txtIdProvincia" class="form-control custom-select" required>
                                    ...
                                    <?php 
                                        ...
                                        if(!empty($_SESSION["idUtilizador"]) && $_SESSION["tipoAcesso"] != "ceo"){
                                            ...
                                            $provincia = $provincias->BuscarPorID($idProvincia);
                                            ?>
                                    <option selected value="<?php echo $provincia["idProvincia"];?>">
                                ...
                                <center>
                                    ...
                                    <div class="col-8" style="margin-top: -15px">
                                        <input title="Deve conter no míninimo 3 caracteres" minlength="3"
                                            ...
                                            class="form-control" type="text" name="txtNomeProvincia"
                                            id="txtNomeProvincia">
                                        <div class="invalid-feedback" style="font-size: 16px; text-align: left">
                                            Introduza o nome
                                        </div>
...
<!--AJAX PARA BUSCAR ProvinciaES-->
<script src="/assets/js/provincia/ajaxBuscarProvincias.js"></script>
