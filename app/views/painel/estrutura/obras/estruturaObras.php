        ...
        <div class="col mt-2 pb-4 d-flex justify-content-center" style="display: block; flex-wrap: wrap; background: #57489b;">
            <div class="d-table justify-content-center" style="width: 100%">
                ...
                <div class="col text-center d-table d-md-flex bg-white text-dark" style="border: 5px solid #299;border-radius: 10px; margin-top: 10px; width: 100%">
                    ...
                    <button id="album" onClick="Album()" style=" font-weight: bold; border-bottom: 5px solid black; border-radius: 10px; width: 300px" class="btn w-50 m-3 border border-warnning p-1" type="button" >
                            <i class='fas fa-folder-minus' style="font-size: 20px"></i> Álbum
                    </button>
                    

                    <button id="obra" onClick="Obra()" style=" font-weight: bold; border-bottom: 5px solid black; border-radius: 10px; width: 300px" class="btn w-50 m-3 border border-warnning p-1" type="button">
                            <i class='fas fa-music' style="font-size: 20px"></i> Obra
                    </button>
                    

                    <button id="listaReproducao" onClick="ListaReproducao()" style=" font-weight: bold; border-bottom: 5px solid black; border-radius: 10px; width: 300px" class="btn w-50 m-3 border border-warnning p-1" type="button">
                            <i class='fas fa-play' style="font-size: 20px"></i> Lista de reprodução
                    </button>
                    

                    <button id="estilo" onClick="Estilo()" style=" font-weight: bold; border-bottom: 5px solid black; border-radius: 10px; width: 300px" class="btn w-50 m-3 border border-warnning p-1" type="button" >
...
<script>
        ...
        function Album(){window.location = "/painel/Obras/Album";}
        function Estilo(){window.location = "/painel/Obras/Estilo";}
        function ListaReproducao(){window.location = "/painel/Obras/ListaReproducao";}
        function Obra(){window.location = "/painel/Obras/Obra";}
</script>
