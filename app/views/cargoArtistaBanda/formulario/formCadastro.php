<!--MAIN-->
<form action="/cargoArtistaBanda/Cadastrar" method="post" class="needs-validation" novalidate>
                ...
                <div class="col pb-1 ">
                    <center>
                        <div class="col-8 pb-5 mb-3 d-none d-md-block d-lg-block d-xl-block"
                            ...
                            <legend class="">Adicionar Cargo de Banda</legend>
                        </div>

                        <div class="col d-md-none d-lg-none d-xl-none">
                            <h5>Adicionar Cargo de Banda</h5>
                        </div>
                    </center>
                </div>
            </div>
